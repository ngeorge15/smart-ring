...
export function DeviceStrip() {
  ...
  const stale = !DATA.readiness.is_today;

  return (
    <div className="rise mb-3 flex items-center gap-3 rounded-[13px] border border-hairline
                    bg-surface-1 px-3.5 py-2.5 text-[12px]">
      ...
      {stale && (
        <span className="shrink-0 rounded-full border border-hairline px-2 py-0.5
